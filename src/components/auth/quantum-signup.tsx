  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: "linear-gradient(rgba(0,0,0,0) 50%, rgba(0,0,0,0.5) 50%)", backgroundSize: "100% 2px" }}
      />
      <div className="absolute top-[-15%] right-[-10%] w-[50%] h-[50%] bg-violet-500/5 rounded-full blur-[120px] pointer-events-none animate-pulse" />
      <div className="absolute bottom-[-15%] left-[-10%] w-[50%] h-[50%] bg-emerald-500/5 rounded-full blur-[120px] pointer-events-none animate-pulse" />

      {/* HUD corners */}
      <div className="absolute top-6 left-6 pointer-events-none"><div className="w-6 h-6 border-l-2 border-t-2 border-violet-500/40" /></div>
      <div className="absolute top-6 right-6 pointer-events-none"><div className="w-6 h-6 border-r-2 border-t-2 border-violet-500/40" /></div>
      <div className="absolute bottom-6 left-6 pointer-events-none"><div className="w-6 h-6 border-l-2 border-b-2 border-violet-500/40" /></div>
      <div className="absolute bottom-6 right-6 pointer-events-none"><div className="w-6 h-6 border-r-2 border-b-2 border-violet-500/40" /></div>

      <div className="absolute top-8 left-1/2 -translate-x-1/2 flex items-center gap-2 text-violet-500/50 pointer-events-none">
        <Radio className="w-3 h-3 animate-pulse" />
        <span className="text-[9px] tracking-[0.4em]">NOVO PROTOCOLO · INICIALIZANDO</span>
      </div>
      ...
      >
        <header className="text-center space-y-2">
          <div className="flex items-center justify-center gap-3 mb-1">
            ...
            <span className="text-[9px] text-violet-500/60 tracking-[0.5em]">GG EMPRÉSTIMOS</span>
            <div className="w-8 h-px bg-violet-500/40" />
          </div>
          <h1 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-500 tracking-tighter">
            CRIAR CONTA
          </h1>
          <p className="text-[10px] text-slate-600 tracking-widest">REGISTRO DE NOVO OPERADOR · v2.0</p>
        </header>

        <div
          className="relative"
          style={{ filter: isHovered ? "drop-shadow(0 0 24px rgba(139,92,246,0.2))" : "none" }}
        >
          <div
            className={`absolute -inset-px rounded-2xl transition-all duration-500 pointer-events-none ${isHovered ? "opacity-100" : "opacity-0"}`}
            style={{
              background: "linear-gradient(135deg, rgba(139,92,246,0.4), rgba(6,182,212,0.4), rgba(16,185,129,0.2))",
              filter: "blur(1px)",
            }}
          />
            ...
            <SignUp
              appearance={{
                ...
                elements: {
                  ...
                  formFieldInput: "border-slate-700 bg-slate-900/80 text-white focus:border-violet-500 focus:ring-violet-500/20",
                  formFieldLabel: "text-slate-400 text-xs tracking-wider uppercase",
                  formButtonPrimary: "bg-violet-500 hover:bg-violet-400 text-white font-bold tracking-wider transition-all",
